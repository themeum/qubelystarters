            ...
            >
                <FontPreviewLink
                    ...
                    label={this.props.inheritDefault
                        ? __('Inherit', 'qubelystarters')
                        : __('Default', 'qubelystarters')}
                    onClick={() => {
                ...
                <div className='popover-content'>
                    ...
                    <ul className='qubelystarters-fonts-list'>
                        {options.length ? options
                            : <li className='no-result' key='no-results'>{__('No results.', 'qubelystarters')}</li>}
                    </ul>
                </div>
            </Fragment>
        )
