...
if ( ! function_exists( 'mix' ) ) {
	...
	function mix( $path, $manifest_directory = '' ) {
		...
		if ( ! $manifest_directory ) {
			// Setup path for standard Qubely_Starters-Folder-Structure.
...
if ( ! function_exists( 'qubelystarters_plugin_activation' ) ) :
	...
	function qubelystarters_plugin_activation() {
		$plugins = array(
			array(
				'name'               => esc_html__( 'Qubely - Advanced Gutenberg Blocks', 'qubelystarters' ),
				'slug'               => 'qubely',
				'required'           => true,
				'version'            => '',
			...
			array(
				'name'               => esc_html__( 'One Click Demo Import', 'qubelystarters' ),
			...
			array(
				'name'               => esc_html__( 'Cheetah Performance', 'qubelystarters' ),
				'slug'               => 'cheetah',
		...
		$config = array(
			...
			'strings'          => array(
				...
				'complete'         => esc_html__( 'All plugins installed and activated successfully. %s', 'qubelystarters' ),
			),
		);
