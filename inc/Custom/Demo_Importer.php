...
class Demo_Importer {
	...
	public function change_text( $default_text ) {
		$default_text .= '<div class="demo__intro-text"><h3>' . __( 'Welcome to Qubely Starters One Click Demo Import', 'qubelystarters' ) . '</h3></div>';
	...
	public function change_plugin_page( $default_settings ) {
		$default_settings['parent_slug'] = 'qubelystarters';
		$default_settings['page_title']  = esc_html__( 'Qubely Starters One Click Demo Import', 'qubelystarters' );
		$default_settings['menu_title']  = esc_html__( 'Demo Import', 'qubelystarters' );
